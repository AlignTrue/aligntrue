...
2. Paste a GitHub blob/raw URL (e.g., `.../blob/main/rules/align.md`) **or** a repo path containing `.align.yaml`.
3. Click **Generate Align**.
...
Learn how packs work in [Align YAML packs](/docs/concepts/align-yaml-packs).
