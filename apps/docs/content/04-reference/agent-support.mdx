---
title: Agent support
description: Complete compatibility matrix for AlignTrue's 51 exporters supporting 33 AI coding agents
---
...
AlignTrue supports **33 AI coding agents** through **51 exporters**. Each exporter generates agent-specific configuration files from your AlignTrue rules, ensuring your AI assistants stay aligned across your entire development workflow.

## Coverage statistics

- **51 exporters** supporting **33 agents**
- **14 MCP configurations** for protocol-based agents
- **25 agent-specific format exporters** for native configurations
- **12 universal format exporters** using AGENTS.md
- **1 dual-output exporter** with both universal + specific formats
