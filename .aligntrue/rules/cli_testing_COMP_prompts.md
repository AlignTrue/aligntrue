...
```
Execute Layer 2 (Solo Golden Paths) from .aligntrue/rules/cli_testing_playbook_COMP.md.
...
```
Execute Layer 4 (Command Coverage) from .aligntrue/rules/cli_testing_playbook_COMP.md.
...
```
Execute Layer 5 (Statefulness) from .aligntrue/rules/cli_testing_playbook_COMP.md.
...
```
Execute Layer 6 (Environment Matrix) from .aligntrue/rules/cli_testing_playbook_COMP.md.
...
```
Execute Layer 7 (Error & UX) from .aligntrue/rules/cli_testing_playbook_COMP.md.
...
```
Execute Layer 8 (Exploratory) from .aligntrue/rules/cli_testing_playbook_COMP.md.
...
```
Execute all layers from .aligntrue/rules/cli_testing_playbook_COMP.md sequentially.
